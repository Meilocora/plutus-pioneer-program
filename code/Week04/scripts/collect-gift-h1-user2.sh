...
name="$1"       # franny
collateral="$2" # utxo from franny (Hash + # + Index) 
txin="$3"       # TxHash from the vested funds     (utxo = TxHash + # + TxIx)
slot="$4"       # number of a slot corresponding to the deadline from the datum
